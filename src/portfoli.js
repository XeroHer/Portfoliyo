  ...
  return (
    <>
        ...
        <div className="about-content">
          ...
          <div className="about-text">
            ...
            <div className="bottom-section">
              <h1>Hi :)</h1>
              <p>
                👋I'm <strong>Bikesh Kumar Raut</strong>, a{" "}
                <strong>Full Stack Developer</strong> and{" "}
                <strong>Computer Science graduate</strong> from the{" "}
                <strong>University of East London</strong>. I have experience
                developing <strong>responsive web applications</strong> at{" "}
                <strong>Docklands Creative Organization</strong> using{" "}
                <strong>React</strong>, <strong>TypeScript</strong>, and modern
                web technologies. I enjoy building <strong>full-stack</strong>,{" "}
                <strong>AI-powered</strong>, and{" "}
                <strong>blockchain-based applications</strong> that solve
                real-world problems. My projects include an{" "}
                <strong>AI Job Portal</strong>, a{" "}
                <strong>Web3 e-commerce platform</strong>, and an{" "}
                <strong>YOLOv8 object detection system</strong>. I'm passionate
                about <strong>learning new technologies</strong>,{" "}
                <strong>automating processes</strong>, and building solutions
      ...
      <section id="experience" className="section">
        <h2
          style={{
            backgroundColor: "rgba(210, 164, 13, 0.263)",
            paddingTop: "2rem",
          }}
        >
          EXPERIENCE & PROJECTS
      ...
      >
        View Figma Design
          ...
          <div className="experience-card">
            ...
            <h4>2026</h4>
            <p>
              A full-stack web application leveraging AI to match job seekers
              with the right jobs and provide recruiters an intuitive dashboard.
            </p>
            <ul>
            ...
            <p>
              ...
              <a
                href="https://github.com/XeroHer/AI_JOB_PORTAL"
                target="_blank"
                rel="noreferrer"
              >
                AI_JOB_PORTAL
            ...
            <p>
              ...
              <a
                href="https://github.com/XeroHer/AIJobBackend"
                target="_blank"
                rel="noreferrer"
              >
                AIJobBackend
            ...
            <p>
              ...
              <a
                href="https://aijobbackend.onrender.com/"
                target="_blank"
                rel="noreferrer"
              >
          ...
          <div className="experience-card">
            ...
            <p>
              A full-stack e-commerce platform integrating both blockchain-based
              and traditional payment systems, designed to provide secure,
              flexible, and seamless shopping experiences.
            </p>

            <ul>
              <li>
                Designed a full-stack e-commerce platform with 10+ core
                features, including product uploads, cart management, secure
                checkout, and order tracking
              </li>

              <li>
                Implemented role-based access for customers and vendors,
                enabling smooth multi-user interactions
              </li>

              <li>
                Built a responsive cart and product management system with full
                CRUD operations, optimizing UI performance and state management
              </li>

              <li>
                Integrated blockchain payments using smart contracts with
                MetaMask and traditional payment processing via Stripe
              </li>

              <li>
                Enhanced transaction security and flexibility through
                decentralized and centralized payment support
              </li>
            </ul>
          ...
          <div className="experience-card">
            ...
            <p>
              ...
              using Natural Language Processing (NLP) and Machine Learning to
              improve hiring outcomes and ATS compatibility.
            </p>
          ...
          <div className="experience-card">
            ...
            <p>
              An academic AI project focused on training the YOLOv8 model using
              the KITTI Vision Benchmark Suite dataset for autonomous driving
              and real-time road-scene object detection.
            </p>
            ...
            <ul>
              ...
              <li>
                Applied computer vision techniques for autonomous driving
                research
              </li>
              <li>
                Optimized object detection for road-scene image processing
              </li>
            </ul>
      ...
      <footer id="footer">
        <div className="footer-content">
          <div className="footer-social">
            ...
            <div className="social-item">
              <a
                href="https://github.com/XeroHer?tab=repositories"
                target="_blank"
                rel="noreferrer"
            ...
            <div className="social-item">
              <a
                href="https://www.freecodecamp.org/fcc719a956f-5f7d-41d7-ad10-54abd57aa9af"
                target="_blank"
                rel="noreferrer"
                className="social-icon"
              >
